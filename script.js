$(function () {
  ...
  function changeText() {
    ...
    let labelName = document.querySelector(
      'label[for="zammad-form-name-inline"]'
    );
    labelName.innerText = "Ime";
    let labelEmail = document.querySelector(
      'label[for="zammad-form-email-inline"]'
    );
    labelEmail.innerText = "Email";
    let labelBody = document.querySelector(
      'label[for="zammad-form-body-inline"]'
    );
